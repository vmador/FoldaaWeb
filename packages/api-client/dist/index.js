...
class FoldaaClient {
    ...
    async login(apiKey) {
        ...
        this.supabase = (0, supabase_js_1.createClient)(this.supabase.supabaseUrl, this.supabase.supabaseKey, {
    ...
    async deployProject(params) {
        ...
        if (pwaIcons) {
            if (Array.isArray(pwaIcons)) {
                ...
                icon192 = pwaIcons.find((i) => i.sizes === '192x192')?.src || params.pwaAssets?.favicon || '';
                icon512 = pwaIcons.find((i) => i.sizes === '512x512')?.src || icon192;
            }
            else {
...
exports.FoldaaClient = FoldaaClient;
